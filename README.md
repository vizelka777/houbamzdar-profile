...
5. **Chat service (опционально, отдельный микросервис)**:
   - Для выделенного чата используйте отдельный Bunny Magic Container app и отдельную Bunny Database.
   - Монолит остаётся источником пользователей и сессий, а chat-service хранит только комнаты и сообщения.
   - Подробности в [`docs/chat-service.md`](/home/houbamydar/houbamzdar-mvp/docs/chat-service.md).
...
- `docs/chat-service.md` — отдельный chat-service, `chat_token`, rooms/DM и вторая Bunny Database.
